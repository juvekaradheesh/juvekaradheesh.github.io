...
export const publications = [
	{
		title: 'One Editor, Many Edits: A Unified Training-free Framework for Diverse Video Edits',
		authors: 'Adheesh Juvekar, Onkar Kishor Susladkar, Kiet A. Nguyen, Nabeel Bashir, Xiaona Zhou, Muntasir Wahed, Vedant Shah, Ismini Lourentzou',
		journal: 'In preparation',
		time: '2026',
		abstract: 'A training-free editing framework that reuses a single editor to support diverse video edits across multiple tasks without per-task training.',
		image: '/papers/one-editor.svg',
		notes: 'In preparation',
	},
	{
		title: 'GraphVid: Interactive Graph Control Video Generation',
		authors: 'Vedant Shah, Onkar Kishor Susladkar, Tushar Prakash, Kiet A. Nguyen, Tianjiao Yu, Adheesh Juvekar, Muntasir Wahed, Ismini Lourentzou',
		journal: 'In preparation',
		time: '2026',
		abstract: 'GraphVid lets users steer video generation via interactive graph controls that align structure, motion, and semantics.',
		image: '/papers/graphvid.svg',
		notes: 'In preparation',
	},
	{
		...
		abstract: 'We propose UniDFlow, a unified discrete flow-matching framework for multimodal understanding, generation, and editing. It decouples understanding and generation via task-specific low-rank adapters, avoiding objective interference and representation entanglement, while a novel reference-based multimodal preference alignment optimizes relative outcomes under identical conditioning, improving faithfulness and controllability without large-scale retraining. UniDFlow achieves state-of-the-art performance across eight benchmarks and exhibits strong zero-shot generalization to tasks including inpainting, in-context image generation, reference-based editing, and compositional generation, despite no explicit task-specific training.',
		image: '/papers/unidflow.svg',
	},
	{
		...
		journal: 'arXiv preprint arXiv:2601.16210 • Accepted at CVPR 2026',
		time: '2026',
		...
		notes: 'In preparation for camera-ready',
	...
	},
	{
		...
		journal: 'arXiv preprint arXiv:2506.21546 • Accepted at CVPR 2026',
		time: '2026',
		...
		notes: '* Equal contribution • In preparation for camera-ready',
		image: '/papers/halluseg.jpg',
	},
	{
		title: 'RewardFlow: Generate Images by Optimizing What You Reward',
		authors: 'Onkar Kishor Susladkar, Dong-Hwan Jang, Tushar Prakash, Adheesh Juvekar, Vedant Shah, Ayush Barik, Muntasir Wahed, Ritish Shrirao, Ismini Lourentzou',
		journal: 'Accepted at CVPR 2026',
		time: '2026',
		abstract: 'RewardFlow optimizes image generation pipelines by directly aligning outputs with user-defined reward signals, enabling more reliable control over synthesis objectives.',
		notes: 'In preparation for camera-ready',
		link: 'https://plan-lab.github.io/projects/rewardflow',
		image: '/papers/rewardflow.svg',
	},
	{
